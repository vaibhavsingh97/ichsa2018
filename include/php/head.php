  ...
  <header>
    ...
    <div class="navbar" id="navigation">
              ...
              <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                  <li>
                    ...
                    <div class="collapsible-body">
                      <ul>
                        <li><a href="CallForPapers.php">Call for papers &nbsp;&nbsp;<span class="new badge"></span></a></li>
                        <li class="divider"></li>
      ...
      <ul id='Home-dropdown-content' class='dropdown-content'>
        ...
        <li class="divider"></li>
        <li class="Dropdown-menu-links"><a href="Awards.php">Awards</a></li>
        <li class="divider"></li>
      ...
      <ul id='Authors-dropdown-content' class='dropdown-content'>
        <li class="Dropdown-menu-links"><a href="CallForPapers.php">Call for papers &nbsp;&nbsp;<span class="new badge"></span></a></li>
        <li class="divider"></li>
      ...
      <ul id='test' class='dropdown-content'>
        ...
        <li class="divider"></li>
        <li><a href="StudentVolunteers.php">Student Volunteers</a></li>
        <li class="divider"></li>
        <li><a href="NationalAdvisoryCommitee.php">National Advisory Commitee</a></li>
        <li class="divider"></li>
        <li><a href="InternationalAdvisoryCommitee.php">International Advisory Commitee</a></li>
      </ul>
